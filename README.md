# Frontend Mentor - Note-taking web app
...
We've included HTML files for the authentication flow. However, if you're not building the project as a full-stack app, you can ignore these.
